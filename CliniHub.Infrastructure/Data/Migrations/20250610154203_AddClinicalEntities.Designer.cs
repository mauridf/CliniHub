...
namespace CliniHub.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250610154203_AddClinicalEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.Atestado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.BloqueioAgendaMedico", b =>
                {
                    ...
                    b.ToTable("BloqueiosAgendaMedicos");
                });
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.Consulta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.ItemReceita", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ItensReceitas", (string)null);
                });
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.Medicamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.PedidoExame", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.Receita", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.TipoExame", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.Atestado", b =>
                {
                    b.HasOne("CliniHub.Core.Domain.Entities.Consulta", "Consulta")
                        .WithMany("Atestados")
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.Consulta", b =>
                {
                    b.HasOne("CliniHub.Core.Domain.Entities.Agendamento", "Agendamento")
                        .WithOne("Consulta")
                        .HasForeignKey("CliniHub.Core.Domain.Entities.Consulta", "AgendamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.ItemReceita", b =>
                {
                    b.HasOne("CliniHub.Core.Domain.Entities.Medicamento", "Medicamento")
                        .WithMany("ItensReceitas")
                        .HasForeignKey("MedicamentoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CliniHub.Core.Domain.Entities.Receita", "Receita")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("CliniHub.Core.Domain.Entities.PedidoExame", b =>
                {
                    ...
                    b.HasOne("CliniHub.Core.Domain.Entities.Laudo", "Laudo")
                        .WithMany()
                        .HasForeignKey("LaudoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CliniHub.Core.Domain.Entities.TipoExame", "TipoExame")
                        .WithMany("PedidosExames")
